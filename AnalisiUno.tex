...
\def\tmp{#1}
\regex_replace_once:nnN { "! } { 91848243 }\tmp
...
\input{AnalisiUno-00-introduzione.tex_}

\tableofcontents

\mainmatter

\input{AnalisiUno-01-reali.tex_}

\input{AnalisiUno-02-successioni.tex_}

\input{AnalisiUno-03-serie.tex_}

\input{AnalisiUno-04-complessi.tex_}

\input{AnalisiUno-05-funzioni.tex_}

\input{AnalisiUno-06-integrali.tex_}

\input{AnalisiUno-07-spazi.tex_}

\input{AnalisiUno-07-uniforme.tex_}

\input{AnalisiUno-08-ricorrenza.tex_}

\input{AnalisiUno-09-edo.tex_}
