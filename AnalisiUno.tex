...
\newcommand{\online}[1]{\marginnote{\qrcode[height=1.7cm]{#1}\\\scriptsize{(interagisci)}~}}
\newcommand{\myqrcode}[2]{\marginnote{\qrcode[height=1.7cm]{#1}\\{\footnotesize #2}}}
...
\input{chapters/AnalisiUno-00-introduzione.tex_}

\tableofcontents

\mainmatter

\input{chapters/AnalisiUno-01-reali.tex_}

\input{chapters/AnalisiUno-02-successioni.tex_}

\input{chapters/AnalisiUno-03-serie.tex_}

\input{chapters/AnalisiUno-04-complessi.tex_}

\input{chapters/AnalisiUno-05-funzioni.tex_}

\input{chapters/AnalisiUno-06-integrali.tex_}

\input{chapters/AnalisiUno-07-spazi.tex_}

\input{chapters/AnalisiUno-07-uniforme.tex_}

\input{chapters/AnalisiUno-08-ricorrenza.tex_}

\input{chapters/AnalisiUno-09-edo.tex_}

\backmatter

\input{chapters/AnalisiUno-99-appendix.tex_}
