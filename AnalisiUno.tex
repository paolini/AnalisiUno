...
% \newcommand{\myhref}[2]{\href{#1}{\underline{#2}}} %% currently not used?
...
\newcommand{\online}[2]{%
  ...
  \write\myauxfile{<!--ONLINE--><li><a href="#1">#2</a> (pagina \thepage, capitolo \thechapter)</li>}%
  }
%
% #1: url della pagina
...
%\includeonly{chapters/AnalisiUno-05-funzioni}
...
\include{chapters/AnalisiUno-05-funzioni}

\include{chapters/AnalisiUno-06-integrali}

\include{chapters/AnalisiUno-07-spazi}

\include{chapters/AnalisiUno-07-uniforme}
