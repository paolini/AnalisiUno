...
%\newcommand{\mymark}[1]{\begin{textblock}{1}(0,0){#1}\end{textblock}}
%\newcommand{\mymark}[1]{\noindent\hbox to 0pt {\hss{#1}\hskip -1em}}
%\newcommand{\mymark}[1]{\marginnote[left]{}}
%\newcommand{\mymark}[1]{\llap{\makebox[12mm][l]{#1}}}
