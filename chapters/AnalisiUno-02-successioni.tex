...
\[
  \sup_n a_n, \inf_n a_n, \max_n a_n, \min_n a_n 
\]
...
utilizzare la definizione~\ref{def:monotonia} per verificare
...
Si ha 
\[
\lim_{x\to 0}  \enclose{1 + x}^{\frac 1 {x}} \to e.
\]
\end{theorem}
%
\begin{proof}
Dimostriamo il risultato utilizzando il teorema ponte~\ref{th:ponte}.
Sia dunque $a_k\to 0$, $a_k\neq 0$ una successione reale.
