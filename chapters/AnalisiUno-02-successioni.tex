...
\begin{example}
Sappiamo che le funzioni esponenziali, potenza, logaritmo, radice $n$-esima,
sono funzioni continue e componendole tra loro sommandole e moltiplicandole 
si ottengono ancora funzioni continue. 
Se facciamo il limite in un punto del dominio sappiamo allora 
che basta sostituire il punto limite per trovare il risultato:
\[
\lim_{x\to 1} 
  \frac{\sqrt[3]{x+\log_2 (x^2+1)}}{(\sqrt{2})^x}
 = \frac{\sqrt[3]{1+\log_2 (1^2+1)}}{(\sqrt{2})^1}
