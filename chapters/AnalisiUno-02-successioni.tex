...
siano state definite\marginnote{%
...
\marginnote{Non è possibile fare confronti tra valori complessi, visto che
...
accumulato genera anch'esso interesse\marginnote{%
...
\index{$e$}%
\marginnote{Nepero è l'italianizzazione del nome del
...
che il minimo esiste e quindi non è detto che la sfera sia il minimo: 
potrebbero esserci infinite superfici $S_1, S_2, \dots, S_n, \dots$ ognuna 
con area minore di quella della sfera e ognuna con area maggiore della successiva: 
$A(S_{n+1})< A(S_n)$. Per concludere il ragionamento di Eulero era necessario 
dimostrare che in una situazione del genere le superifici $S_n$ debbano, 
in qualche senso, tendere alla superficie sferica e che le loro aree debbano
