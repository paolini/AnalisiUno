...
\begin{proof}
  ...
  \[
   a_{n_{k+1}}\ge \max\ENCLOSE{k+1, a_0, a_1, \dots, a_{n_k}}.
  \]
...
\item per ogni $x\in I$
  \begin{enumerate}
    \item se $x\neq \inf I$ allora $f(x) = \sup f(\ENCLOSE{y \in I\colon y<x})$,
    \item e se $x\neq \sup I$ allora $f(x) = \inf f(\ENCLOSE{y \in I \colon y>x})$.
  \end{enumerate}
\end{enumerate}
...
%
\begin{proof}
Sia $A_x = \ENCLOSE{y \in I\colon y<x }$ e $B_x = \ENCLOSE{y\in I \colon y>x}$.
...
$A'_y=\ENCLOSE{t \in J\colon t<y}$.
Essendo $f$ monotona e invertibile,
posto $x=f^{-1}(y)$ e $A_x=\ENCLOSE{ s\in I\colon s<x}$
si ha $f^{-1}(A'_y) = A_x$ e chiaramente $\sup A_x = x$.
Dunque $\sup f^{-1}(A'_y) = x = f^{-1}(y)$. In maniera analoga
si dimostra che $\inf f^{-1}(\ENCLOSE{t\in J \colon t>y}) = f^{-1}(y)$
...
In particolare se $p\in \ZZ$ e $q \in \NN\setminus\ENCLOSE{0}$ si ha
\[
...
Definiamo ora
\begin{align*}
  A_x &= \ENCLOSE{t\in \QQ\colon t<x} = \QQ \cap (-\infty,x),
  \\
  B_x &= \ENCLOSE{t\in \QQ\colon t>x} = \QQ \cap (x,+\infty).
\end{align*}
