...
In alternativa si potrebbe scrivere $\oldvec a$ oppure evitare
...
Se $a_n$ è una successione complessa diremo che $a_n$ diverge e scriveremo
$a_n \to \infty$
se
\[
  \forall M\in \RR\colon \exists N \in \NN \colon \forall n\in \NN \colon
...
Si faccia attenzione al fatto che una successione $a_n\in \RR$
...
se $a_n \to \infty$ (in $\bar \CC$) significa che $\abs{a_n}\to +\infty$ quindi
se $a_n > 0$ definitivamente allora si ha $a_n\to +\infty$
se $a_n < 0$ definitivamente allora
$a_n\to -\infty$ ma se frequentemente $a_n> 0$ e frequentemente $a_n < 0$
allora $a_n$ non ha limite in $\bar \RR$ pur avendolo in $\bar \CC$
...
Utilizziamo il teorema~\ref{th:cont_sequenziale}:
...
e di $g$. Il rapporto $f/g$ è definito sui punti dell'intersezione
dei domini dove, inoltre, $g(x)\neq 0$.
La composizione $(f\circ g)(x)=f(g(x))$
 è definita
sui punti $x$ del dominio di $g$ tali che $g(x)$ sta nel dominio di $f$.
Il valore assoluto $\abs{f}$
...
Se $a_n \to a$ allora per il teorema~\ref{th:cont_sequenziale}
