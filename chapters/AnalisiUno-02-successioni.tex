...
\begin{corollary}[limiti notevoli]
\mymark{*}%
...
Diremo invece che $a_n$ e $b_n$ (sempre successioni a termini positivi)
...
sono strumenti molto importanti nel calcolo dei limiti.

Innanzitutto è facile verificare
(si applichino le definizioni)
che
queste relazioni soddisfano la proprietà transitiva:
se $a_n\ll b_n$ e $b_n\ll c_n$ allora
$a_n \ll c_n$
e se $a_n\sim b_n$ e $b_n\sim c_n$
allora $a_n \sim c_n$.
Inoltre l'equivalenza asintotica
si mantiene per prodotto e rapporto:
se $a_n\sim b_n$ e $c_n\sim d_n$ allora
\[
 a_n \cdot c_n \sim b_n \cdot d_n,
 \qquad
 \frac{a_n}{c_n} \sim \frac{b_n}{d_n}.
\]


E' banale osservare che se $a_n\ll b_n$ allora
$a_n+b_n \sim b_n$ in quanto
\[
  \frac{a_n + b_n}{b_n} = \frac{a_n}{b_n} + 1 \to 0 + 1 = 1.
\]
Inoltre se $a_n \sim b_n$ e se $a_n\to \ell$ allora anche $b_n\to \ell$.
...
\[
\lim_{n\to+\infty}
\frac{2n^4 + 4^n - 3 \ln n}{n! - 3n}.
\]
\end{example}
\begin{proof}[Svolgimento.]
Si ha
\[
\frac{2n^4 + 4^n - 3 \ln n}{n! - 3\sqrt{n}}
= \frac
{4^n \enclose{2\frac{n^4}{4^n}+ 1 - 3\frac{\ln n}{4^n}}}
{n!\enclose{1-3\frac{\sqrt n}{n!}}}
\]
...
\sqrt n \ll n!
\]
avremo quindi, essendo $4^n \ll n!$
\[
\frac{2n^4 + 4^n - 3 \ln n}{n! - 3\sqrt{n}}
\sim \frac{4^n}{n!} \to 0.
\]
Dunque il limite cercato è $0$.
\end{proof}
