...
Per le successioni, come per tutte le funzioni,
le operazioni $\sup$, $\inf$,
$\max$, $\min$ si intendono eseguite sull'insieme
dei valori della successione. In particolare
