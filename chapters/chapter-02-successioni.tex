...
\mynote{%
Si noti che non abbiamo definito la funzione potenza $z^w$
tra numeri complessi e anzi tale funzione non può essere definita in 
maniera univoca. 
}
\[
 e^z = \exp(z).  
...
Si noti che la funzione esponenziale compless è $2\pi i$ periodica, infatti 
se $z=x+iy$ si ha 
\[
\exp(z+2\pi i) 
= \exp(x+i(y+2\pi))  
...
della linea rettificata sarà uguale alla lunghezza della linea curva originaria.
}.
\end{definition}
