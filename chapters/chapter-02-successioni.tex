...
dominio e codominio reale, dominio e codominio complesso, dominio reale e codominio complesso, 
dominio complesso e codominio reale, cominio reale 
e codominio complesso. 
Noi ci concentreremo sul primo caso, ma quando possibile daremo 
gli enunciati anche per il secondo caso.
Il terzo e il quarto caso, per quello che faremo in questo corso, 
si potranno ricondurre al secondo considerando che 
un sottoinsieme di $\RR$ è anche sottoinsieme di $\CC$.}
%
...
In caso contrario si otterrebbe un limite diverso.}
\[
