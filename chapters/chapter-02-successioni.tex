...
\]
I due numeri $\rho>0$ e $\theta\in\closeopeninterval{0}{2\pi}$ 
...
Le formule di conversione da coordinate polari $\theta,\rho$ 
a coordinate cartesiane $x,y$ è molto semplice:
\begin{cases}
 x = \rho \cos \theta,\\
 y = \rho \sin \theta.
\end{cases}
Le formule inverse sono invece più antipatiche 
da scrivere, si ha infatti:
\begin{cases}
 \rho = \sqrt{x^2+y^2}\\
 \theta = \arg z
\end{cases}
