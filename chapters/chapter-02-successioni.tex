...
\mynote{intorni destri/sinistri}%
...
e scriveremo\mynote{limite di funzione}%
...
% \mymark{**}%
% \mynote{prodotto limitata per infinitesima}%
...
\mynote{limiti che si riconducono al numero $e$}%
...
\begin{definition}[ordine di infinito/infinitesimo]%
  ...
  \mymark{***}%
  \mynote{ordine di infinito/infinitesimo}%
...
%% \mynote{non numerabilità dei reali}%
...
\index{punto!limite} di $f(x)$ per $x\to x_0$ se 
  ...
  \mynote{limite superiore/inferiore}%
...
\mymark{**}%
\mynote{proprietà dei valori intermedi}%
...
\mynote{successioni mi\-ni\-miz\-zan\-ti}%
...
e al variare di $x\in [a,b]$ il punto descrive una traiettoria in $\RR^n$.
