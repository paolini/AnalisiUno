...
da cui 
\[
\pi = \ell(\vec u) = 4 \ell(\vec u \llcorner[0,1/\sqrt 2]).  
\]
...
e quindi $\sqrt{1-s^2} \ge \sqrt{1-t^2} \ge 1/\sqrt 2$,
si ha 
\[
  \dots 
...
\[
  \abs{\vec u(t)-\vec u(s)}
  =\sqrt{(t-s)^2 + (\sqrt{1-s^2}-\sqrt{1-t^2})^2}
  \le \sqrt{(t-s)^2 + (t-s)^2} \le \sqrt 2 (t-s).  
\]
Questo ci permette di concludere che 
\[
\pi = 4 \ell(\vec u\llcorner [0,1/\sqrt 2])
\le 4 \sqrt 2 \cdot \frac{1}{\sqrt 2} = 4.  
\]
\end{proof}
