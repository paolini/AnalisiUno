...
\mynote{autovalore}\index{autovalore} di $A$
e esiste $v\in V$, $v\neq 0$ tale che
\[
  Av = \lambda v.
\]
In tal caso $v$ si dice essere un \emph{autovettore}%
\mynote{autovettore}\index{autovettore} di $A$ relativo
...
\mynote{autospazio}\index{autospazio} relativo all'autovalore $\lambda$.
