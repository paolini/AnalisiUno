...
The following code is written in \emph{python 3}%
\mymargin{python 3}\index{python 3}
a programming language
widely used for numerical and scientific computation.
