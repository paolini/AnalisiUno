...
E' banale osservare che $\forall A\colon A\subset A$
in quanto $x\in A \implies x\in A$. 
Dunque l'assioma di uguaglianza, $A=A$, può essere in realtà dimostrato.
...
\begin{axiom}[singoletto]
  Per ogni $x$ esiste l'insieme $\ENCLOSE{x}$, 
