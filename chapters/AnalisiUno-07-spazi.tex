...
Se $\phi$ è una norma su $V$ (definizione~\ref{def:norma} 
diremo che $V$
...
Se $b$ è un prodotto scalare (definizione~\ref{def:prodotto_scalare}} 
definito positivo su $V$ diremo che $V$ è uno
spazio \emph{euclideo} (con prodotto scalare $b$).

Se $b$ è un prodotto scalare definito positivo su $V$ il teorema~\ref{th:spazio_euclideo} ci garantisce che
...
Per $p=2$ si ottiene la norma euclidea
$\abs{v}_2=\abs{v}$ (si ).
Per $p=1$
