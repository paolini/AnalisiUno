...
che i punti $f(p/2^n)= \Re \phi(p/2^n)$ siano abbastanza ravvicinati tra loro.
...
Per $n=1$ si verifica che 
verificando che è soddisfatta per $n=1$ e che 
$u_1=\frac{1+i}{\sqrt 2}$ e quindi,
