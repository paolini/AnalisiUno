...
a_4 &= \frac{17/12 + 2/(17/12)}{2} = 577 / 408 \sim 1.4142157,\\
\vdots
\end{align*}
...
\begin{figure}
  \online{http://paolini.github.io/recurrence/?expr=1\%2B1\%2Fx&x=1&scale=170&xoff=1.5&yoff=0.8}%
  {Diagramma a ragnatela relativo all'esercizio \getrefnumber{ex_fibonacci}}
  \begin{center}
...
\begin{figure}
  \online{http://paolini.github.io/recurrence/?expr=1\%2Bx*x&x=1&scale=20&yoff=9&x=0}%
  {Diagramma a ragnatela relativo all'esercizio \getrefnumber{ex_3}}
  \begin{center}
...
\begin{figure}
  \online{http://paolini.github.io/recurrence/?expr=4-1\%2Fx&x=1&scale=50&yoff=1&xoff=1}%
  {Diagramma a ragnatela relativo all'esercizio \getrefnumber{ex_4}}
  \begin{center}
...
\begin{figure}
 \online{http://paolini.github.io/recurrence/?expr=1-1\%2Fx&x=0.5&scale=50}%
 {Diagramma a ragnatela relativo all'esercizio \getrefnumber{ex_5}}
 \begin{center}
...
\begin{figure}
  \online{http://paolini.github.io/recurrence/?expr=(5-x*x)\%2F4&x=0&scale=120}%
  {Diagramma a ragnatela relativo all'esercizio \getrefnumber{ex_6}}
  \begin{center}
...
\begin{figure}
 \online{http://paolini.github.io/recurrence/?expr=2-x*x&x=-1.105&scale=100}%
 {Diagramma a ragnatela relativo all'esercizio \getrefnumber{ex_7}}
   \begin{center}
...
\begin{figure}
 \online{http://paolini.github.io/recurrence/?expr=1\%2F(2-x)&x=1.3&scale=50}%
 {Diagramma a ragnatela relativo all'esercizio \getrefnumber{ex_8}}
 \begin{center}
...
discriminante negativo. Significa che $x^+c > x$ per ogni $x\in \RR$. Dunque
...
invariante. Dunque la successione $a_n$ rimane in tale intervallo.
...
\begin{equation}\label{eq:ricorsione_lineare}
  c_n a_{k+n} + c_{n-1} a_{k+n-1} + c_{n-2} a_{k+n-2} + \dots
    + c_1 a_{k+1} + c_0 a_k = 0
\end{equation}
...
\end{equation}
Sia ora $R=1/\max\{\abs{\lambda_1}, \dots, \abs{\lambda_n}\}$ (almeno uno dei $\lambda_j$
...
\begin{pmatrix}
  ...
  1 & \lambda_2 & \dots & \lambda_2^n \\
  \vdots & \vdots & \ddots & \vdots \\
  1 & \lambda_n & \dots & \lambda_n^n
\end{pmatrix}
\]
che notoriamente è invertibile se
...
\[
  \ker J = \{\vec a \in W \colon J(\vec a)=0\}.
\]
...
Se $c\in \RR$ l'insieme dei numeri reali è invariante, dunque la successione
$z_n$ rimane reale e coincide con la successione che abbiamo
studiato nell'esercizio~\ref{ex:mandelbrot_reale}.

\begin{figure}
\begin{center}
\includegraphics[height=5cm]{mandelbrot.png}
\end{center}
...
dal sistema~\eqref{eq:mandelbrot}, solo con l'utilizzo dei primi calcolatori
...
è contenuto nel disco $\{z\in \CC \colon \abs{z}\le 2\}$.
\end{exercise}
%
\begin{proof}{Soluzione.}
...
\[
  A_\eps = \{z \in \CC \colon \abs{z}\ge c \text{ e } \abs{z}\ge 2+\eps\}.
\]
