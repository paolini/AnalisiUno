...
delle $x$ vanno in $A$ mentre proiettati sull'asse delle $y$ vanno in $B$.
...
%
  ...
  \end{center}
  \caption{La funzione $f\colon A\to B$, $f=\{(a_1,b_1), (a_2, b_3), (a_3, b_2), (a_4, b_3)\}$
...
alla coppia come ad una \emph{freccia} che parte dall'oggetto $a$
 ...
 un insieme come dei punti (o nodi) il prodotto cartesiano
