...
Per una relazione $R\subset A\times B$ si userà la notazione $aRb$
...
come vedremo, nel teorema~\ref{th:cantor_secondo}.
...
una relazione d'\emph{ordine totale} $\le$ cioè una relazione
...
\end{gather*}
Scriveremo $a<b$ per intendere $a\le b \land a\neq b$.
