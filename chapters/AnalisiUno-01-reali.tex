...
\begin{theorem}[proprietà delle potenze reali]
...
Sappiamo che la funzione $f$ è strettamente crescente
positiva e continua.
Sia $J=f(\RR)$.
Grazie al teorema~\ref{th:inversa_monotona}
sappiamo che $J$ è un intervallo e $f\colon \RR\to J$
è invertibile.
...
Sappiamo anche che $\inf J>=0$ in quanto $f$ è positiva.
Ma risulta anche $\inf J \le \inf \ENCLOSE{a^{-n}\colon n \in \NN}=0$.
Dunque $J=(0,+\infty)$ e $f\colon \RR \to (0,+\infty)$
è bigettiva con inversa continua e strettamente crescente.
...
$(0,+\infty)\to \RR$
strettamente decrescente, bigettiva e continua.
