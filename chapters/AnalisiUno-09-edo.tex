...
\myqrdoclink{\myshorturl{43856}}{(interagisci)}{i grafici delle soluzioni dell'equazione differenziale (\getrefnumber{eq:43856})}}
\begin{figure}
\centering
...
\myqrdoclink{\myshorturl{94467}}{(interagisci)}{Il baffo di Peano formato dalle soluzioni del problema di Cauchy (\getrefnumber{eq:94467})}}
\begin{figure}
\centering
...
\newsavebox{\qrsistemisella}\sbox{\qrsistemisella}{%
  \myqrdoclink{\myshorturl{sistemi_sella}}{(interagisci)}{sistemi lineari: sella}}
\newsavebox{\qrsisteminodo}\sbox{\qrsisteminodo}{%
  \myqrdoclink{\myshorturl{sistemi_nodo}}{(interagisci)}{sistemi lineari: nodo}}
\newsavebox{\qrsisteminodoimproprio}\sbox{\qrsisteminodoimproprio}{%
  \myqrdoclink{\myshorturl{sistemi_nodo_improprio}}{(interagisci)}{sistemi lineari: nodo improprio}}
\newsavebox{\qrsistemistella}\sbox{\qrsistemistella}{%
  \myqrdoclink{\myshorturl{sistemi_stella}}{(interagisci)}{sistemi lineari: stella}}
\newsavebox{\qrsistemifuoco}\sbox{\qrsistemifuoco}{%
  \myqrdoclink{\myshorturl{sistemi_fuoco}}{(interagisci)}{sistemi lineari: fuoco}}
\newsavebox{\qrsistemicentro}\sbox{\qrsistemicentro}{%
  \myqrdoclink{\myshorturl{sistemi_centro}}{(interagisci)}{sistemi lineari: centro}}
\begin{figure}
\centering
 \begin{subfigure}{5cm}
  \centering\includegraphics[width=0.75\textwidth]{sistemi_sella.pdf}
  \caption[1a]{sella (instabile)\\\usebox{\qrsistemisella}}
 \end{subfigure}
 \begin{subfigure}{5cm}
  \centering\includegraphics[width=0.75\textwidth]{sistemi_nodo.pdf}
  \caption{nodo stabile\\\usebox{\qrsisteminodo}}
 \end{subfigure}
 \begin{subfigure}{5cm}
 \centering\includegraphics[width=0.75\textwidth]{sistemi_nodo_improprio.pdf}
  \caption{nodo improprio stabile\\\usebox{\qrsisteminodoimproprio}}
 \end{subfigure}
 \begin{subfigure}{5cm}
  \centering\includegraphics[width=0.75\textwidth]{sistemi_stella.pdf}
  \caption{stella stabile\\\usebox{\qrsistemistella}}
 \end{subfigure}
 \begin{subfigure}{5cm}
  \centering\includegraphics[width=0.75\textwidth]{sistemi_fuoco.pdf}
  \caption{fuoco stabile\\\usebox{\qrsistemifuoco}}
 \end{subfigure}
 \begin{subfigure}{5cm}
  \centering\includegraphics[width=0.75\textwidth]{sistemi_centro.pdf}
  \caption{centro (stabile)\\\usebox{\qrsistemicentro}}
 \end{subfigure}
\end{figure}
...
\myqrdoclink{\myshorturl{exo_463}}{(interagisci)}{Studio qualitativo esempio~\ref{ex:edo_463}}}
\begin{figure}
