...
Una operazione binaria $*$ è una funzione $*\colon A\times B \to C$
che associa ad ogni coppia $(a,b)$ con $a\in A$ e $b\in B$ un elemento $c\in C$.
Invece di scrivere $c = *(a,b)$ scriveremo $c = a*b$.
Se $A=B=C$ diremo che $*$ è un'operazione su $A$.

\begin{example}
Su $A=\ENCLOSE{-1,0,1}$ possiamo definire l'usuale operazione di 
moltiplicazione come la funzione $\cdot \colon A\times A \to A$
con grafico:
\[
G_\cdot = \ENCLOSE{
  (-1,-1)\mapsto 1, (-1,0)\mapsto 0, (-1,1)\mapsto -1, 
  (0,-1)\mapsto 0, (0,0)\mapsto 0, (0,1)\mapsto 0, 
  (1,-1)\mapsto -1, (1,0)\mapsto 0, (1,1)\mapsto 1}.
\]
Scriveremo allora $-1\cdot 1 = -1$, $0\cdot 0 = 0$, $1\cdot 1 = 1$ etc... 
\end{example}
