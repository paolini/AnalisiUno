...
Ad esempio se abbiamo i teoremi: $x>1 \implies x^2>1$, 
$x<-1 \implies x^2>1$,  
$x>1 \lor x<-1$ allora dedurre che $x^2>1$ 
è un teorema.
...
Cogliamo l'occasione per osservare che $P$ e $Q$ 
non sono simboli del sistema formale ma sono simboli 
segnaposto che utilizziamo nel metalinguaggio naturale
che stiamo utilizzando per spiegare i sistemi formali.
