...
grande di insiemi infiniti, uno diverso dall'altro.
...
scrivere nella forma:
  $\exists \omega\colon I(\omega) \land \forall \alpha\colon I(\alpha)\implies \omega\subset \alpha$
}
...
\mymargin{Anche questa è una somma \emph{telescopica}}
...
\begin{enumerate}
  ...
  \item $\sin$ è strettamente crescente 
    sull'intervallo $\closeinterval{-\frac \tau 4}{\frac \tau 4}$;
  \item $\cos x$ è strettamente decrescente 
    sull'intervallo $\closeinterval{0}{\frac \tau 2}$.
\end{enumerate}
\end{theorem}
%
\begin{proof}
