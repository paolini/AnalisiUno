...
e poi il punto $\frac \tau 4$ su $i$, il punto $\tau$ su $-1$,
...
e per ogni $n\in \NN$ esiste $x\in(0,u]$ tale che 
$nx = y$.
\end{theorem}
%
\begin{proof}
...
continuità dell'ordinamento. Fissato $y$ e $n$ si considerano gli insiemi 
\[
  A_y = \ENCLOSE{x\in(0,u]\colon \forall k\in \NN\colon k\le n\implies kn \in [0,x) },
  \qquad 
...
E infine estendiamo il teorema~\ref{th:isomorfismo}.
%
\begin{theorem}[isomorfismo locale]
