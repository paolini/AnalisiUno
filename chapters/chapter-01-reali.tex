...
facilmente estendere anche l'operazione di moltiplicazione.
...
risulta essere un campo totalmente ordinato e continuo.

Inoltre ogni campo totalmente ordinato e continuo è isomorfo a $\RR$.
\end{theorem}
\begin{proof}
...
dunque $\RR$ è un campo totalmente ordinato e continuo.

Sia ora $R$ un qualunque campo totalmente ordinato e continuo. 
E' facile verificare che $R$ è denso: dati $x,y\in R$ 
si ha che il punto medio $\frac{x+y}{2}$ è compreso tra $x$ e $y$.
Inoltre in $R$ si ha $1\neq 0$, dunque $R$ non è banale.
Significa allora che $R$ è isomorfo ad $\RR$ come gruppo 
totalmente ordinato denso e continuo.
Ma il teorema~\ref{th:moltiplicazione_reali} ci dice che c'è un solo 
modo per definire la moltiplicazione su $R$ in modo da renderlo un campo,
dunque anche la moltiplicazione di $R$ coincide con quella di $\RR$
