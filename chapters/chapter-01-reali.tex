...
\begin{example}
Per fare un esempio di relazione d'ordine in cui non esiste il massimo 
bisogna considerare un insieme infinito.
Ad esempio vedremo che l'insieme dei numeri naturali non ha maggioranti 
...
più grande di ogni numero naturale, otteniamo che $\infty$ 
è l'estremo superiore di tutti i numeri naturali. 
Ma non è il massimo dei numeri naturali, non essendo lui stesso un numero naturale.
\end{example}
