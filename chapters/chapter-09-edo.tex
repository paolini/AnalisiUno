...
\mymargin{condizione iniziale}\index{condizione iniziale} ovvero si fissa un
...
\mymargin{problema di Cauchy}\index{problema!di Cauchy}.
...
\mynote{Per quanto riguarda l'esistenza si potrebbe scegliere 
direttamente $I=[x_0-\delta,x_0+\delta]$ perché avere esistenza su un 
intervallo più grande ci dà più informazione.
Ma un intervallo più piccolo ci dà invece più informazione sull'unicità:
non è possibile che due soluzioni coincidano neanche se restringiamo 
arbitrariamente l'intervallo in cui sono definite.} %
