...
Esiste $0\in \NN$ e $\sigma\colon \NN \to \NN$ tali che:
\begin{enumerate}
...
\]
La relazione $\ge$ è la relazione inversa di $\le$. La relazione $<$ si
definisce richiedendo che $x<y$ valga se $x\le y \land x\neq y$ e la relazione $>$
