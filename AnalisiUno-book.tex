\documentclass[italian,paperwidth=7in,paperheight=10in,twoside,headinclude]{scrbook}
\usepackage{amsmath,amssymb,amsthm,thmtools}
\usepackage{mathtools} % per \MoveEqLeft
\usepackage{babel}
\usepackage[nochapters,pdfspacing]{myclassicthesis}
%\usepackage{createspace/createspace}
\usepackage[paperwidth=7in,paperheight=10in,bindingoffset=0.625in,marginparwidth=70.7pt,marginparsep=11.9pt]{geometry}
%\paperwidth 7in
%\paperheight 10in
%%\bindingoffset 0.5in
%\typearea{10}
